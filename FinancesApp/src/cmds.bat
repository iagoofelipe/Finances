...
pyside6-uic FinancesApp\src\ui\RegForm.ui -o FinancesApp\src\ui\auto\ui_RegForm.py
pyside6-uic FinancesApp\src\ui\LoginForm.ui -o FinancesApp\src\ui\auto\ui_LoginForm.py
pyside6-rcc FinancesApp\src\ui\resource.qrc -o FinancesApp\src\ui\auto\resource_rc.py