...
from finances.ui.auto.ui_ConfigForm import Ui_ConfigForm
from finances.core.structs import User, Profile, ShareProfile
from finances.core.tools import isDarkTheme, generateStyleSheet
from finances.core.consts import SHARE_TYPE_EDIT, SHARE_TYPE_VIEW
from finances.view.component.table import TableWidget
from finances.view.component.dialog.shareProfile import ShareProfileDialog
