...
from finances.ui.auto.ui_CardAccountForm import Ui_CardAccountForm
from finances.view.component.dialog import MessageDialog
from finances.view.component.table import TableWidget
from finances.core.tools import generateStyleSheet
from finances.core.structs import Card, Account, CardTableItem, AccountTableItem

class CardAccountForm(QWidget):
