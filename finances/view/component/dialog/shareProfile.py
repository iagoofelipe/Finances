...
from finances.core.tools import generateInputForm, generateComboBox
from finances.core.consts import MSG_SHARE_PROFILE, SHARE_TYPE_EDIT, SHARE_TYPE_PROPERTY, SHARE_TYPE_VIEW
from finances.core.structs import ShareProfile, Profile
